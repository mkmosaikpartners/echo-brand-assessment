    ...
    <>
      ...
      >
        ...
        <p style={{ fontSize: 18, lineHeight: 1.5, marginBottom: 28 }}>
          Branche: <b>{result.industry}</b> · Branchenposition:{" "}
          <b>{result.industry_positioning}</b> · Reifegrad:{" "}
          <b>{result.maturity}</b>
        </p>
        ...
        <Section title="Executive-Implikation">
          <div style={{ fontSize: 18, lineHeight: 1.7 }}>
            {result.executive_implication}
          </div>
        </Section>

        <div
          className="no-print"
          style={{ display: "flex", gap: 16, marginTop: 20, marginBottom: 20 }}
        >
          <button
            style={primaryButton}
        ...
        <div className="no-print" style={{ fontSize: 14, color: "#555" }}>
